   ...
   public class Hud extends MovieClip
   {
      ...
      public function update(param1:StickWar, param2:Team) : void
      {
         ...
         if(param1.isReplay == false)
         {
            ...
            if(param1.gameScreen.userInterface.keyBoardState.isDown(79))
            {
            ...
            this.hud.night.text = "Night Day: " + this.nightDay;
            this.hud.night.visible = true;
