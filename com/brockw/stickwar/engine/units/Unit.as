package com.brockw.stickwar.engine.units
{
   ...
   public class Unit extends Entity
   {
      ...
      public function updateStatus() : void
      {
         ...
         {
            if(this.isPoisoned() || this._poisonDamage > 0)
            {
               if(this.type == Unit.U_ENSLAVED_GIANT && !this.isTowerSpawned)
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
                  this.clusterLad.py = this.py;
                  Dead(this.clusterLad).giant();
                  this.clusterLad.deadType = "Giant";
               ...
               if(this.type == Unit.U_GIANT && !this.isTowerSpawned)
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
               ...
               if(this.type == Unit.U_SPEARTON && this.generalType != "general" && !this.isTowerSpawned)
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
                  this.clusterLad.py = this.py;
                  this.clusterLad.deadType = "Heavy";
                  Dead(this.clusterLad).heavy();
                  this.clusterLad.stun(60);
                  this.directionAtBurrow = getDirection();
                  team.game.projectileManager.initMound(px,py,0,team,-this.directionAtBurrow);
               }
               if(this.type == Unit.U_ARCHER && this.generalType == "general")
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
                  this.clusterLad.py = this.py;
                  this.clusterLad.deadType = "";
                  this.clusterLad.stun(60);
                  Dead(this.clusterLad).range();
                  this.directionAtBurrow = getDirection();
                  team.game.projectileManager.initMound(px,py,0,team,-this.directionAtBurrow);
               }
               if(this.type == Unit.U_ARCHER && this.generalType != "general")
               ...
               if(this.type == Unit.U_NINJA)
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
                  this.clusterLad.py = this.py;
                  this.clusterLad.deadType = "Light";
                  Dead(this.clusterLad).light();
                  this.clusterLad.stun(60);
                  this.directionAtBurrow = getDirection();
                  team.game.projectileManager.initMound(px,py,0,team,-this.directionAtBurrow);
               }
               if(this.type == Unit.U_MONK)
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
               ...
               if(this.type == Unit.U_SWORDWRATH && this.generalType != "general")
               {
                  this.clusterLad = team.game.unitFactory.getUnit(Unit.U_DEAD);
                  team.enemyTeam.spawn(this.clusterLad,team.game);
                  this.clusterLad.px = this.px;
