package com.brockw.stickwar.engine.maps
{
   ...
   public class Map
   {
      ...
      protected function createGoldBlock1(param1:StickWar, param2:Number, param3:int) : void
      {
         var _loc4_:Gold = new Gold(param1);
         (_loc4_ = new Gold(param1)).init(param2 + param3 * 70,this._height / 2 + 60,1.0e+28,param1);
         this._gold.push(_loc4_);
         param1.units[_loc4_.id] = _loc4_;
      }
      
      protected function createGoldBlock2(param1:StickWar, param2:Number, param3:int) : void
      {
         var _loc4_:Gold = new Gold(param1);
         (_loc4_ = new Gold(param1)).init(param2 + param3 * 70,this._height / 2 - 60,1.0e+28,param1);
         this._gold.push(_loc4_);
