package com.brockw.simulationSync
{
   ...
   public class SimulationSyncronizer
   {
      ...
      public function SimulationSyncronizer(param1:Simulation, param2:BaseMain, param3:Function, param4:Function)
      {
         super();
      ...
      public function set gameReplay(param1:GameReplay) : void
      {
      ...
      public function set game(param1:Simulation) : void
      {
         this._game = param1;
      }
   }
