package com.brockw.stickwar.engine.units
{
   ...
   public class Swordwrath extends Unit
   {
      ...
      public function enableGeneral() : void
      {
         ...
         _damageToArmour = 35;
         _damageToNotArmour = 45;
         RAGE_COOLDOWN = team.game.xml.xml.Order.Units.swordwrath.rage.cooldown;
         RAGE_EFFECT = team.game.xml.xml.Order.Units.swordwrath.rage.effect * 1.5;
         this.rageSpell = new SpellCooldown(RAGE_EFFECT,RAGE_COOLDOWN,team.game.xml.xml.Order.Units.swordwrath.rage.mana);
