   ...
   public class Player
   {
      ...
      public function Player(param1:XMLList)
      {
         ...
         if(this.race == "Order")
         {
            ...
            this.unitsAvailable[Unit.U_SWORDWRATH] = 1;
            this.unitsAvailable[Unit.U_ARCHER] = 1;
            this.unitsAvailable[Unit.U_MONK] = 1;
            this.unitsAvailable[Unit.U_MAGIKILL] = 1;
            this.unitsAvailable[Unit.U_SPEARTON] = 1;
            this.unitsAvailable[Unit.U_NINJA] = 1;
            this.unitsAvailable[Unit.U_FLYING_CROSSBOWMAN] = 1;
            this.unitsAvailable[Unit.U_ENSLAVED_GIANT] = 1;
         }
         this.statue = "default";
