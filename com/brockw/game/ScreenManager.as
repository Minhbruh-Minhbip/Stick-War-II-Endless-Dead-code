package com.brockw.game
{
   ...
   public class ScreenManager extends Sprite
   {
      ...
      public function addScreen(param1:String, param2:Screen) : Boolean
      {
      ...
      private function switchToNextScreen() : Boolean
      {
         ...
         var _loc1_:Screen = this.screens[this.nextScreenName];
         var _loc2_:Screen = this.screens[this.currentScreenName];
         if(_loc2_ != null)
         {
            _loc2_.x = 0;
            this.screens[this.currentScreenName].leave();
      ...
      {
         var _loc2_:Screen = this.screens[this.nextScreenName];
         var _loc3_:Screen = this.screens[this.currentScreenName];
