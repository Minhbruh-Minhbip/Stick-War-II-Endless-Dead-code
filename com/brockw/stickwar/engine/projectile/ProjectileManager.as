package com.brockw.stickwar.engine.projectile
{
   ...
   public class ProjectileManager
   {
      ...
      public function ProjectileManager(param1:StickWar)
      {
         ...
         this._projectileMap[Projectile.BITE] = new Pool(10,Bite,param1);
         this.projectiles = [];
      ...
      public function initBite(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Unit, param9:Unit = null) : void
      {
         var _loc10_:Bite;
         if((_loc10_ = Bite(this._projectileMap[Projectile.BITE].getItem())) == null)
         {
            return;
         }
         _loc10_.initProjectile();
